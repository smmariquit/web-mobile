  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:image', content: 'https://web.stimmie.dev/og-image.jpg' },
        { property: 'og:image:width', content: '1200' },
        { property: 'og:image:height', content: '630' },
        { property: 'og:image:alt', content: 'Simonee Mariquit — Production-ready code. Clear finish line.' },
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:title', content: 'Simonee Mariquit · Web & Mobile Developer' },
        { name: 'twitter:description', content: 'Freelance web and mobile work that reaches real users. Scope doc, fixed quote, shipped projects you can click through.' },
        { name: 'twitter:image', content: 'https://web.stimmie.dev/og-image.jpg' },
        { name: 'twitter:image:alt', content: 'Simonee Mariquit — Production-ready code. Clear finish line.' },
